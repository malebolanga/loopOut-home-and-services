...
const Footer = () => {
  ...
  return (
    <>
      ...
      {/* Main Footer */}
     <footer className="hidden md:block bg-gradient-to-b from-gray-900 to-gray-800 text-gray-300 pt-16 pb-8 mt-24">
...
<footer className="md:hidden bg-gradient-to-b from-gray-900 to-gray-800 text-gray-300 pt-0 pb-8 mt-24">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="border-t border-gray-700/50 pt-8 mt-8">
      <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        <div className="flex items-center space-x-6">
