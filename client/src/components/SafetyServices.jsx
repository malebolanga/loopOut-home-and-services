...
const SafetyServices = {
  ...
  schoolTransport: { icon: "🚌", label: "School Transport" }
};
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 flex items-center justify-center">
            ...
            HomeServices Pro Comprehensive Safety Policy
          </h1>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Ensuring Safe Experiences for All Home Service Categories
          </p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="bg-white p-8 rounded-xl shadow-lg mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {Object.entries(SafetyServices).map(([key, service]) => (
        ...
        <div className="space-y-12">
          ...
          <section id="platform-role">
            <h2 className="text-3xl font-bold mb-6 flex items-center">
              ...
              HomeServices Pro Role as a Platform
            </h2>
              ...
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    HomeServices Pro operates solely as an advertising platform connecting service providers 
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-3">
                    <li><strong>Cleaning Services:</strong> Bonding and insurance verification</li>
                    <li><strong>Maintenance:</strong> Trade certifications and licenses</li>
                    <li><strong>Moving Services:</strong> Vehicle insurance and licensing</li>
                    <li><strong>Landscaping:</strong> Pesticide application certifications</li>
                    <li><strong>Catering:</strong> Food safety and handling certifications</li>
                    <li><strong>DayCare:</strong> Childcare certifications and first aid training</li>
                    <li><strong>School Transport:</strong> Commercial drivers license and background checks</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-3">
                    ...
                    <li>Be present during the entire service duration when possible</li>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="border p-4 rounded-lg">
                  <h4 className="font-semibold mb-2 text-blue-700">🧹 Cleaning Services</h4>
                  <ul className="list-disc pl-5 space-y-2 text-sm">
                    <li>Use of non-toxic cleaning products</li>
                    <li>Proper handling of cleaning chemicals</li>
                    <li>Secure storage of customer keys</li>
                    <li>Respect for personal spaces and items</li>
                    <li>Waste disposal protocols</li>
                  </ul>
                </div>
                <div className="border p-4 rounded-lg">
                  <h4 className="font-semibold mb-2 text-blue-700">🛠️ Maintenance Services</h4>
                  <ul className="list-disc pl-5 space-y-2 text-sm">
                    <li>Proper tool safety and storage</li>
                    <li>Electrical safety protocols</li>
                    <li>Use of personal protective equipment</li>
                    <li>Proper disposal of hazardous materials</li>
                    <li>Work area safety barriers</li>
                  </ul>
                </div>
                <div className="border p-4 rounded-lg">
                  <h4 className="font-semibold mb-2 text-blue-700">🚚 Moving Services</h4>
                  <ul className="list-disc pl-5 space-y-2 text-sm">
                    ...
                    <li>Route planning and safety</li>
                  </ul>
                </div>
                <div className="border p-4 rounded-lg">
                  <h4 className="font-semibold mb-2 text-blue-700">🌿 Landscaping</h4>
                  <ul className="list-disc pl-5 space-y-2 text-sm">
                    <li>Equipment safety protocols</li>
                    <li>Chemical handling and storage</li>
                    <li>Weather-related safety measures</li>
                    <li>Property boundary respect</li>
                    <li>Waste disposal procedures</li>
                  </ul>
                </div>
                <div className="border p-4 rounded-lg">
                  <h4 className="font-semibold mb-2 text-blue-700">🍽️ Catering Services</h4>
                  <ul className="list-disc pl-5 space-y-2 text-sm">
                    <li>Food safety and temperature control</li>
                    <li>Allergy awareness and disclosure</li>
                    <li>Sanitation and hygiene protocols</li>
                    <li>Equipment safety and setup</li>
                    <li>Emergency food handling procedures</li>
                  </ul>
                </div>
                <div className="border p-4 rounded-lg">
                  <h4 className="font-semibold mb-2 text-blue-700">👶 DayCare Services</h4>
                  <ul className="list-disc pl-5 space-y-2 text-sm">
                    <li>Child safety and supervision protocols</li>
                    <li>Emergency contact verification</li>
                    <li>First aid and CPR certification required</li>
                    <li>Safe environment childproofing</li>
                    <li>Background checks mandatory</li>
                  </ul>
                </div>
                <div className="border p-4 rounded-lg">
                  <h4 className="font-semibold mb-2 text-blue-700">🚌 School Transport</h4>
                  <ul className="list-disc pl-5 space-y-2 text-sm">
                    <li>Vehicle safety inspections</li>
                    <li>Child safety seat protocols</li>
                    <li>Route safety planning</li>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-3">
                    ...
                    <li>Report incident to HomeServices Pro within 24 hours</li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-3">
                    ...
                    <li>Use safety features in the HomeServices Pro app</li>
                    <li>Notify trusted contacts immediately</li>
                    <li>Document incidents with photos if safe</li>
                    <li>Report safety concerns to HomeServices Pro promptly</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mt-8 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div>
                    <p className="font-semibold">HomeServices Pro Safety Team</p>
                    <p>safety@homeservicespro.com</p>
                    <p>1-800-HOME-SAFE</p>
                  </div>
                  <div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                ...
                <p className="text-yellow-700">
                  HomeServices Pro does not process payments for services. All financial transactions 
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    HomeServices Pro explicitly disclaims any liability for damages, injuries, or disputes that may 
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <p className="text-blue-700">
                    ...
                    seek resolution through appropriate legal channels. HomeServices Pro s role is limited to providing 
          ...
          <section>
            <div className="bg-red-50 border border-red-200 p-6 rounded-xl">
              ...
              <p className="text-red-700 mb-4">
                By using HomeServices Pro to book or provide services, you acknowledge and agree that HomeServices Pro acts 
                solely as an advertising platform. You assume all risks associated with arranging and 
                receiving services, and release HomeServices Pro from any liability for damages, injuries, or 
