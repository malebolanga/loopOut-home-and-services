...
export default function OverNight() {
  ...
  useEffect(() => {
    const fetchKinds = async () => {
      try {
        ...
        setAvailableKinds(["all", "hotel", "guesthouse", "bnb", "motel"]); // Fallback
  ...
  const fetchListings = useCallback(
    async (reset = false) => {
      ...
      let url = `/api/listing/get?type=over&limit=15&page=${currentPage}`;
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {recentlyViewed.length > 0 && (
            <section className="mb-10">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-bold text-gray-800">Recently viewed overnight stays</h2>
                  {recentlyViewed.length > 0 && (
                    <button
        ...
        {loading && page === 1 && overnightListings.length === 0 && recentlyViewed.length === 0 ? (
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-800 mb-6">All overnight stays</h2>
             <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 rounded-2xl">
                ...
                <div className="col-span-full text-center py-8 text-gray-500">
                    You ve seen all the overnight stays! Explore different filters or locations.
                </div>
                )}
            </div>
          </section>
          ...
          <UserMessage
            type="info"
            message="No overnight stays found for your current selection."
            onAction={() => {
              setSelectedKind("all");
              setSearchRadius(5);
            }}
