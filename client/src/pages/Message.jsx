  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-lg text-gray-600">Loading support options...</p>
      </div>
    );
  }
      ...
      <div className="max-w-xl mx-auto relative bg-white rounded-3xl shadow-xl p-6 sm:p-8">
        ...
        {notification.show && (
          <div className={`fixed top-4 right-4 z-50 p-4 rounded-lg shadow-lg flex items-center transition-all duration-300 ease-in-out transform ${
            ...
            <button
              ...
              className="ml-4 text-gray-500 hover:text-gray-700 p-1 rounded-full hover:bg-gray-200 transition-colors"
            >
              <FiX size={18} />
            </button>
          </div>
        ...
        {showReportModal && (
          <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center p-4 z-50 animate-fadeIn">
            <div className="bg-white rounded-3xl p-6 w-full max-w-md shadow-2xl transform scale-95 animate-scaleUp">
              ...
              <form onSubmit={handleReportSubmit} className="space-y-5">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-gray-800 appearance-none"
                    required
                  >
                ...
                <div>
                  ...
                  <textarea
                    id="reportDetails"
                    rows={5}
                    className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-gray-800 resize-y"
                ...
                <div className="flex justify-end gap-3 pt-2">
                  <button
                    type="button"
                    onClick={() => setShowReportModal(false)}
                    className="px-6 py-2 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-100 transition-colors duration-200 font-medium"
                  >
                    Cancel
                  </button>
                  <button
        ...
        <div className="bg-gray-50 rounded-2xl p-6 mb-8 shadow-inner">
          ...
          {chatHistory.length > 0 && (
            <div className="mb-6 space-y-4 max-h-60 overflow-y-auto pr-2 custom-scrollbar">
              ...
              {isAiResponding && (
                <div className="bg-gray-100 text-gray-900 p-4 rounded-xl mr-auto max-w-[85%]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="relative">
                ...
                <textarea
                  id="message"
                  rows={4}
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-gray-800 resize-y"
                ...
                {showAiSuggestions && aiSuggestions.length > 0 && (
                  <div className="absolute z-10 w-full mt-2 bg-white border border-gray-200 rounded-xl shadow-xl max-h-48 overflow-y-auto">
                    <div className="p-3 text-sm font-semibold text-gray-600 border-b border-gray-100">AI Suggestions</div>
                    <ul>
                      {aiSuggestions.map((suggestion, index) => (
                        <li
                          key={index}
                          className="p-3 hover:bg-gray-50 cursor-pointer text-base text-gray-800 transition-colors"
          ...
          <ul className="space-y-3 text-base text-gray-700">
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-0.5">Click to auto-fill your question for the AI assistant.</p>
              </div>
            </li>
            <li className="flex items-start">
              <span className="text-blue-500 mr-2 mt-1">•</span>
