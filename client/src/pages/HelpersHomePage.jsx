  ...
  const filteredHelpers = useMemo(() => {
    ...
    if (searchQuery.trim()) {
      categoryHelpers = categoryHelpers.filter(helper => 
        ...
        helper.address?.toLowerCase().includes(searchQuery.toLowerCase())
      );
    }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-lg font-semibold text-gray-900 dark:text-white">Finding the best professionals...</div>
        </div>
      </div>
    );
  }
