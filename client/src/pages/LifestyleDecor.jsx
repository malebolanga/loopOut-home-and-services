...
export default function LifestyleDecor() {
  return (
    <div className="bg-gray-50 dark:bg-gray-800 min-h-screen py-10">
      <div className="max-w-6xl mx-auto px-2">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-sm p-8 mb-12">
          <h2 className="text-2xl font-bold text-slate-800 dark:text-white mb-8 flex items-center justify-center gap-2">
