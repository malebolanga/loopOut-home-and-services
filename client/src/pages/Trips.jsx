...
export default function Trips() {
  ...
  const TripCard = ({ trip }) => {
    ...
    return (
      <Link 
        to={`/trip/${trip._id}`}
        className="block bg-transparent border border-slate-200/50 rounded-[2.5rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.04)] hover:shadow-xl transition-all duration-500 relative group"
      >
        <div className="p-8">
          <div className="flex justify-between items-start mb-6">
            <div>
              <h3 className="text-2xl font-black text-gray-900 group-hover:text-rose-600 transition-colors tracking-tight italic">
                {trip.name}
              </h3>
          ...
          <div className="flex items-center text-gray-600 text-xs font-bold mt-4 bg-slate-50/50 p-4 rounded-2xl border border-slate-200/30">
          ...
          {trip.stops && trip.stops.length > 0 && (
            <div className="mt-6 pt-6 border-t border-slate-100/50 text-[10px] font-black uppercase tracking-widest text-gray-400 flex flex-wrap gap-2">
               <span className="bg-white/80 border border-slate-100 px-3 py-1.5 rounded-xl shadow-sm">
  ...
  return (
    <div className="min-h-screen py-16 px-6 sm:px-10 lg:px-16 bg-slate-50">
      <div className="max-w-6xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="text-center py-32 bg-white/50 rounded-[4rem] border-2 border-dashed border-slate-200/50">
            ...
            <h2 className="text-4xl font-black text-gray-900 mb-4 tracking-tighter italic">No expeditions found... yet!</h2>
          ...
          <div className="space-y-20 pb-40">
            ...
            {/* Past Trips Section */}
            {pastTrips.length > 0 && (
              <section className="pt-20 border-t border-slate-200/50">
                <div className="flex items-center gap-4 mb-10">
